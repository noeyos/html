...
public class MemberVO {
	...
	public MemberVO(String mem_id, String mem_pass, String mem_name, String mem_bir, String mem_zip, String mem_add1,
			String mem_add2, String mem_hp, String mem_mail) {
		super();
		this.mem_id = mem_id;
		this.mem_pass = mem_pass;
		this.mem_name = mem_name;
